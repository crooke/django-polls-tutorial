...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        ...
        """
        month_ahead = timezone.now() + datetime.timedelta(days=30)
        future_question = Question(pub_date=month_ahead)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        """
        under_one_day = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
        recent_question = Question(pub_date=under_one_day)
...
def create_question(question_text, days):
    ...
    published in the past, positive for question to in future.)
    """
